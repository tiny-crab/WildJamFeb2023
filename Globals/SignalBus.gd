...
# Copied from https://joshanthony.info/2021/08/09/creating-a-global-signal-system-in-godot/
...
# Register a signal with SignalBus, making it accessible to global listeners.
